...
extern void print_operator_io_run_flags(int NO, int NI, uint64_t io_flags, operator_run_opt_flags_t run_opts[NO + NI][NO + NI]);
extern void operator_run_opts_to_io_run_opts(int NO, int NI, uint64_t io_flags, operator_run_opt_flags_t io_run_opts[NO][NI], operator_run_opt_flags_t run_opts[NO + NI][NO + NI]);
extern void operator_io_run_opts_to_run_opts(int NO, int NI, uint64_t io_flags, operator_run_opt_flags_t run_opts[NO + NI][NO + NI], operator_run_opt_flags_t io_run_opts[NO][NI]);

unsigned int operator_index_to_io_index(uint64_t io_flags, unsigned int index, _Bool output);
unsigned int operator_io_index_to_index(uint64_t io_flags, unsigned int io_index, _Bool output);
...
_Bool operator_get_oi_run_opt(int NO, int NI, uint64_t io_flags, operator_run_opt_flags_t run_opts[NO + NI][NO + NI], unsigned int o, unsigned int i, enum OPERATOR_RUN_OPT_FLAGS_INDEX option);
_Bool operator_get_oo_run_opt(int NO, int NI, uint64_t io_flags, operator_run_opt_flags_t run_opts[NO + NI][NO + NI], unsigned int o1, unsigned int o2, enum OPERATOR_RUN_OPT_FLAGS_INDEX option);
_Bool operator_get_ii_run_opt(int NO, int NI, uint64_t io_flags, operator_run_opt_flags_t run_opts[NO + NI][NO + NI], unsigned int i1, unsigned int i2, enum OPERATOR_RUN_OPT_FLAGS_INDEX option);
