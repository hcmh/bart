...
static bool simple_zconvcorr_direct_3D_CF(unsigned int N, const long dims[N], const long ostrs[N], complex float* out, const long istrs1[N], const complex float* in1, const long istrs2[N], const complex float* in2)
{
	size_t size = CFL_SIZE;
	unsigned long flags = 28; //flags of dims 2, 3, 4
...
static bool simple_zconvcorr_direct_3D_CF_TK(unsigned int N, const long dims[N], const long ostrs[N], complex float* dst, const long istrs1[N], const complex float* in1, const long istrs2[N], const complex float* in2)
{
	size_t size = CFL_SIZE;
	unsigned long flags = 28;
	...
	dst -= calc_convcorr_geom(N, flags, tdims, tstrs1, tstrs2, tstrs3,
					odims, MD_STRIDES(N, odims, size),
					kdims, MD_STRIDES(N, kdims, size),
					idims, MD_STRIDES(N, idims, size), conv) / size;
...
static bool simple_zconvcorr(unsigned int N, const long dims[N], const long ostrs[N], complex float* out,
		const long istrs1[N], const complex float* in1, const long istrs2[N], const complex float* in2)
{
	if (simple_zconvcorr_im2col(N, dims, ostrs, out, istrs1, in1, istrs2, in2))
		return true;
