...
extern void md_zss2(unsigned int D, const long dims[D], unsigned int flags, const long str2[D], _Complex float* dst, const long str1[D], const _Complex float* src);
