...
extern _Complex float* init_kaiming_uniform_conv(long N, const long* kernel_dims, _Complex float* src, _Bool c1, float leaky_val);
extern _Complex float* init_kaiming_uniform_conv_complex(long N, const long* kernel_dims, _Complex float* src, _Bool c1, float leaky_val);
extern _Complex float* init_kaiming_normal_conv_complex(long N, const long* kernel_dims, _Complex float* src, _Bool c1, float leaky_val);
extern _Complex float* init_kaiming_normal_conv(long N, const long* kernel_dims, _Complex float* src, _Bool c1, float leaky_val);

extern init_f init_glorot_uniform_dense;
extern init_f init_glorot_uniform_conv;
extern init_f init_glorot_uniform_conv_complex;
extern init_f init_bias;
extern init_f init_auto;
#endif