...
extern void train_nn_mnist(enum MNIST_NETWORK_TYPE type, int N_batch, int N_total, _Complex float* weights, const _Complex float* in, const _Complex float* out, long epochs);
