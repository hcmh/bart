...
extern nn_t nn_permute_inputs(nn_t x, unsigned int I2, const int perm[__VLA(I2)]);
extern nn_t nn_permute_outputs(nn_t x, unsigned int O2, const int perm[__VLA(O2)]);
extern nn_t nn_permute_inputs_F(nn_t x, unsigned int I2, const int perm[__VLA(I2)]);
extern nn_t nn_permute_outputs_F(nn_t x, unsigned int O2, const int perm[__VLA(O2)]);
...
extern nn_t nn_shift_input_index_F(nn_t x, unsigned int n, unsigned int o);
extern nn_t nn_shift_output_index_F(nn_t x, unsigned int n, unsigned int o);
...
extern nn_t nn_sort_inputs_by_list_F(nn_t x, unsigned int N, const char* sorted_names[N]);
