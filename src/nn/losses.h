...
extern const struct nlop_s* nlop_mse_fixed_mask_kspace_create(int N, const long dims[__VLA(N)], unsigned long mean_dims, const long msk_dims[__VLA(N)], const _Complex float* mask);
