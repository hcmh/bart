...
extern const struct nlop_s* nlop_rand_split_fixed_create(int N, const long dims[__VLA(N)], unsigned long shared_dims_flag, unsigned long bat_dims_flag, float p, unsigned long fix_flags, _Complex float* _fix_first);
