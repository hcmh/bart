...
extern struct config_nlop_mri_dc_s conf_nlop_mri_dc_simple;
...
extern struct config_nlop_mri_dc_s* config_nlop_mri_dc_create(void);
extern void config_nlop_mri_dc_free(const struct config_nlop_mri_dc_s* config);
...
extern const struct nlop_s* mri_normal_inversion_create(int N, const long dims[N], const long idims[N], const struct config_nlop_mri_s* conf, const struct config_nlop_mri_dc_s* conf_inv);
extern const struct nlop_s* mri_reg_proj_ker_create(int N, const long dims[N], const long idims[N], const struct config_nlop_mri_s* conf, const struct config_nlop_mri_dc_s* conf_inv);
extern const struct nlop_s* mri_reg_pinv(int N, const long dims[N], const long idims[N], const struct config_nlop_mri_s* conf, const struct config_nlop_mri_dc_s* conf_inv);
