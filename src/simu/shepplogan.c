...
//Create numerical phantom similar to T1-T2-phantom
const struct ellipsis_s t1t2phantom[10] = {
	{	(3. + 1. * I),   { .75,   .75   }, { 0.,     0. },	   0.  },
...
const struct ellipsis_s dens_phantom[10] = {
	{	1.,   { .75,   .75   }, { 0.,     0. },	   0.  },
	{	-1. + 0.5,   { .125,   .125   }, { -0.13,     -0.19 },	   0.  },
	{	-1. + 0.6,   { .125,   .125   }, { -0.45,     -0.32 },	   0.  },
	{	-1. + 0.7,   { .125,   .125   }, { -0.55,     0.05 },	   0.  },
	{	-1. + 0.8,   { .125,   .125   }, { -0.37,     0.37 },	   0.  },
	{	-1. + 0.9,   { .125,   .125   }, { -0.05,     0.55 },	   0.  },
	{	-1. + 1.1,   { .125,   .125   }, { 0.33,     0.40 },	   0.  },
	{	-1. + 1.2,   { .125,   .125   }, { 0.53,     0.12 },	   0.  },
	{	-1. + 1.3,   { .125,   .125   }, { 0.5,     -0.24 },	   0.  },
	{	-1. + 1.4,   { .125,   .125   }, { 0.2,     -0.05 },	   0.  }
};

const struct ellipsis_s bart_img[21] = {
	/* Big Circle */
	{		3. + I,	{ .90,   .90   }, { 0.,     0. },		0.  },
	/* Upper Edge */
	{		-(3. + I) + 0.4 + 0.04*I, 		{ 0.170, 0.050 }, { 2*-0.360, 2*0.140 },	90. / 180. * M_PI  },
	{		-(3. + I) + 0.4 + 0.04*I, { 0.150, 0.050 }, {  2*-0.300,    2*0.210 }, 0. },
	/* Letter "B" */
	{       -(3. + I) + 0.7 + 0.07*I, { 0.280, 0.050 }, { 2*-0.290,    0 },   90. / 180. * M_PI },
	{        -(3. + I) + 0.7 + 0.07*I, { 0.120, 0.050 }, {  2*-0.240,    2*0.125 },    0.   },
	{        -(3. + I) + 0.7 + 0.07*I, { 0.120, 0.050 }, {  2*-0.240,    0 },     0.   },
	{        -(3. + I) + 0.7 + 0.07*I, { 0.120, 0.050 }, {  2*-0.240,   2*-0.125 },     0.   },
	{        -(3. + I) + 0.7 + 0.07*I, { 0.130, 0.050 }, { 2*-0.180,  2*0.065 },  90. / 180. * M_PI   },
	{        -(3. + I) + 0.7 + 0.07*I, { 0.130, 0.050 }, {  2*-0.180,   2*-0.065 },   90. / 180. * M_PI   },
	/* Letter "A" */
	{        -(3. + I) + 1 + 0.1*I, { 0.280, 0.050 }, { 2*-0.090,  0 },   75. / 180. * M_PI  },
	{        -(3. + I) + 1 + 0.1*I, { 0.280, 0.050 }, { 2*-0.020,  0 },   105. / 180. * M_PI  },
	{        -(3. + I) + 1 + 0.1*I, { 0.120, 0.050 }, { 2*-0.055,  2*-0.060 },   0.  },
	/* Letter "R" */
	{        -(3. + I) + 1.3 + 0.13 * I, { 0.280, 0.050 }, { 2*0.070,  0 },  90. / 180. * M_PI  },
	{        -(3. + I) + 1.3 + 0.13 * I, { 0.120, 0.050 }, { 2*0.120,  2*0.125 },   0.  },
	{        -(3. + I) + 1.3 + 0.13 * I, { 0.120, 0.050 }, { 2*0.120,  0 },   0.  },
	{        -(3. + I) + 1.3 + 0.13 * I, { 0.130, 0.050 }, { 2*0.170,  2*0.065 },   90. / 180. * M_PI  },
	{        -(3. + I) + 1.3 + 0.13 * I, { 0.130, 0.050 }, { 2*0.170,  2*-0.065 },  90. / 180. * M_PI   },
	/* Letter "T" */
	{        -(3. + I) + 1.5 + 0.15 * I, { 0.280, 0.050 }, { 2*0.270,  0 },   90. / 180. * M_PI  },
	{        -(3. + I) + 1.5 + 0.15 * I, { 0.160, 0.050 }, { 2*0.270,  2*0.130 },   0.  },
	/* Lower Edge */
	{		-(3. + I) + 1.7 + 0.17 * I, 		{ 0.170, 0.050 }, { 2*0.360, 2*-0.120 },	90. / 180. * M_PI  },
	{		-(3. + I) + 1.7 + 0.17 * I, { 0.150, 0.050 }, {  2*0.300,    2*-0.190 }, 0. }
};
