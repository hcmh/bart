...
const struct ellipsis_bs phantom_tubes2[21] = {
	{{	1.,	{ .0625,	.0625	},	{ -0.065, -0.095 },	0.,	}, false },
	{{	1.,	{ .0625,	.0625	},	{ -0.225, -0.16 },	0.,	}, false },
	{{	1.,	{ .0625,	.0625	},	{ -0.275,  0.025 },	0.,	}, false },
	{{	1.,	{ .0625,	.0625	},	{ -0.185,  0.185 },	0.,	}, false },
	{{	1.,	{ .0625,	.0625	},	{ -0.025,  0.275 },	0.,	}, false },
	{{	1.,	{ .0625,	.0625	},	{  0.165,  0.20 },	0.,	}, false },
	{{	1.,	{ .0625,	.0625	},	{  0.265,  0.06 },	0.,	}, false },
	{{	1.,	{ .0625,	.0625	},	{  0.25, -0.12 },	0.,	}, false },
	{{	1.,	{ .0625,	.0625	},	{  0.10, -0.025 },	0.,	}, false },
	{{	1.,	{ .0625,	.0625	},	{  -0.055, 0.08 },	0.,	}, false },
	{{	1.,	{ .375,	.375		},	{  0.00,  0.00 },	0.,	}, true },
	{{	-1.,	{ .08,	.08		},	{ -0.065, -0.095 },	0.,	}, true },
	{{	-1.,	{ .08,	.08		},	{ -0.225, -0.16 },	0.,	}, true },
	{{	-1.,	{ .08,	.08		},	{ -0.275,  0.025 },	0.,	}, true },
	{{	-1.,	{ .08,	.08		},	{ -0.185,  0.185 },	0.,	}, true },
	{{	-1.,	{ .08,	.08		},	{ -0.025,  0.275 },	0.,	}, true },
	{{	-1.,	{ .08,	.08		},	{  0.165,  0.20 },	0.,	}, true },
	{{	-1.,	{ .08,	.08		},	{  0.265,  0.06 },	0.,	}, true },
	{{	-1.,	{ .08,	.08		},	{  0.25, -0.12 },	0.,	}, true },
	{{	-1.,	{ .08,	.08		},	{  0.10, -0.025 },	0.,	}, true },
	{{	-1.,	{ .08,	.08		},	{  -0.055, 0.08 },	0.,	}, true },
};
