...
{    
	...
	if (2 == data->seq.seq_type || 5 == data->seq.seq_type ) {
		...
		mxy[(data->tmp.run_counter * 3 * data->seq.spin_num * data->seq.rep_num) + (i * data->seq.spin_num * data->seq.rep_num) + 
				(data->tmp.rep_counter * data->seq.spin_num) + data->tmp.spin_counter] = xp[0][i];
				
		sa_r1[(data->tmp.run_counter * 3 * data->seq.spin_num * data->seq.rep_num) + (i * data->seq.spin_num * data->seq.rep_num) + 
				(data->tmp.rep_counter * data->seq.spin_num) + data->tmp.spin_counter] = xp[1][i];
				
		sa_r2[(data->tmp.run_counter * 3 * data->seq.spin_num * data->seq.rep_num) + (i * data->seq.spin_num * data->seq.rep_num) + 
				(data->tmp.rep_counter * data->seq.spin_num) + data->tmp.spin_counter] = xp[2][i];
				
		sa_m0[(data->tmp.run_counter * 3 * data->seq.spin_num * data->seq.rep_num) + (i * data->seq.spin_num * data->seq.rep_num) + 
				(data->tmp.rep_counter * data->seq.spin_num) + data->tmp.spin_counter] = xp[3][i];
		}
	}
	else {
		...
		for (int i = 0; i < N; i++) {
			...
			mxy[(data->tmp.run_counter * 3 * data->seq.spin_num * data->seq.rep_num) + (i * data->seq.spin_num * data->seq.rep_num) + 
					(data->tmp.rep_counter * data->seq.spin_num) + data->tmp.spin_counter] = (data->tmp.rep_counter % 2 == 1) ? tmp[0][i] : xp[0][i];
					
			sa_r1[(data->tmp.run_counter * 3 * data->seq.spin_num * data->seq.rep_num) + (i * data->seq.spin_num * data->seq.rep_num) + 
					(data->tmp.rep_counter * data->seq.spin_num) + data->tmp.spin_counter] = (data->tmp.rep_counter % 2 == 1) ? tmp[1][i] : xp[1][i];
					
			sa_r2[(data->tmp.run_counter * 3 * data->seq.spin_num * data->seq.rep_num) + (i * data->seq.spin_num * data->seq.rep_num) + 
					(data->tmp.rep_counter * data->seq.spin_num) + data->tmp.spin_counter] = (data->tmp.rep_counter % 2 == 1) ? tmp[2][i] : xp[2][i];
					
			sa_m0[(data->tmp.run_counter * 3 * data->seq.spin_num * data->seq.rep_num) + (i * data->seq.spin_num * data->seq.rep_num) + 
					(data->tmp.rep_counter * data->seq.spin_num) + data->tmp.spin_counter] = (data->tmp.rep_counter % 2 == 1) ? tmp[3][i] : xp[3][i];
		}
	}
}
	...
	for (data->tmp.spin_counter = 0; data->tmp.spin_counter < data->seq.spin_num; data->tmp.spin_counter++){
		...
		for (data->tmp.run_counter = 0; data->tmp.run_counter < data->seq.run_num; data->tmp.run_counter++) {
			...
			* ------------------------------------------------------------*/
			...
			if (data->seq.seq_type == 1 || data->seq.seq_type == 4 || data->seq.seq_type == 5 || data->seq.seq_type == 6) {
				
				struct sim_data inv_data = *data;

				if(inv_data.pulse.rf_end != 0) //Hard Pulses
			...
			* ------------------------------------------------------------*/
			...
			if (data->seq.seq_type == 0 || data->seq.seq_type == 1 || data->seq.seq_type == 3 || (data->seq.seq_type == 4 && data->tmp.run_counter == 0) || data->seq.seq_type == 6) { 

				struct sim_data prep_data = *data;
				
				if (data->seq.seq_type == 4)
