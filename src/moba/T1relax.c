...
static void zT1relax_der_0_0(const nlop_data_t* _data, unsigned int o, unsigned int i, complex float* dst, const complex float* src)
{
	UNUSED(o);
	UNUSED(i);
...
static void zT1relax_der_0_1(const nlop_data_t* _data, unsigned int o, unsigned int i, complex float* dst, const complex float* src)
{
	UNUSED(o);
	UNUSED(i);
...
static void zT1relax_der_0_2(const nlop_data_t* _data, unsigned int o, unsigned int i, complex float* dst, const complex float* src)
{
	UNUSED(o);
	UNUSED(i);
...
static void zT1relax_der_1_0(const nlop_data_t* _data, unsigned int o, unsigned int i, complex float* dst, const complex float* src)
{
	UNUSED(o);
	UNUSED(i);
...
static void zT1relax_der_1_1(const nlop_data_t* _data, unsigned int o, unsigned int i, complex float* dst, const complex float* src)
{
	UNUSED(o);
	UNUSED(i);
...
static void zT1relax_der_1_2(const nlop_data_t* _data, unsigned int o, unsigned int i, complex float* dst, const complex float* src)
{
	UNUSED(o);
	UNUSED(i);
...
static void zT1relax_adj_0_0(const nlop_data_t* _data, unsigned int o, unsigned int i, complex float* dst, const complex float* src)
{
	UNUSED(o);
	UNUSED(i);
...
static void zT1relax_adj_0_1(const nlop_data_t* _data, unsigned int o, unsigned int i, complex float* dst, const complex float* src)
{
	UNUSED(o);
	UNUSED(i);
...
static void zT1relax_adj_0_2(const nlop_data_t* _data, unsigned int o, unsigned int i, complex float* dst, const complex float* src)
{
	UNUSED(o);
	UNUSED(i);
...
static void zT1relax_adj_1_0(const nlop_data_t* _data, unsigned int o, unsigned int i, complex float* dst, const complex float* src)
{
	UNUSED(o);
	UNUSED(i);
...
static void zT1relax_adj_1_1(const nlop_data_t* _data, unsigned int o, unsigned int i, complex float* dst, const complex float* src)
{
	UNUSED(o);
	UNUSED(i);
...
static void zT1relax_adj_1_2(const nlop_data_t* _data, unsigned int o, unsigned int i, complex float* dst, const complex float* src)
{
	UNUSED(o);
	UNUSED(i);
...
struct nlop_s* nlop_T1relax_create(int N, const long map_dims[N], const long out_dims[N], const long TI_dims[N], const complex float* TI)
{
	...
	md_copy_strides(N, nl_istr[1], data->map_strs);
        ...
        return nlop_generic_create2(2, N, nl_odims, nl_ostr, 3, N, nl_idims, nl_istr, CAST_UP(PTR_PASS(data)), zT1relax_fun,
                                    (nlop_der_fun_t[3][2]){{ zT1relax_der_0_0, zT1relax_der_1_0 }, {zT1relax_der_0_1, zT1relax_der_1_1 }, { zT1relax_der_0_2,  zT1relax_der_1_2 }},
                                    (nlop_der_fun_t[3][2]){{ zT1relax_adj_0_0, zT1relax_adj_1_0 }, {zT1relax_adj_0_1, zT1relax_adj_1_1 }, { zT1relax_adj_0_2 , zT1relax_adj_1_2 }},
