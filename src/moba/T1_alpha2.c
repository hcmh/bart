...
static void zT1_alpha2_der_0_0(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
...
static void zT1_alpha2_der_0_1(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
        md_zmul2(data->N, data->out_dims, data->out_strs, dst, data->map_strs, src, data->out_strs, data->dM0);
}

static void zT1_alpha2_der_0_2(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);       
        md_zmul2(data->N, data->out_dims, data->out_strs, dst, data->map_strs, src, data->out_strs, data->dR1);
}

static void zT1_alpha2_der_0_3(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);       
        md_zmul2(data->N, data->out_dims, data->out_strs, dst, data->map_strs, src, data->out_strs, data->dalpha);
}

static void zT1_alpha2_der_1_0(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
...
static void zT1_alpha2_der_1_1(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
...
static void zT1_alpha2_der_1_2(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
...
static void zT1_alpha2_der_1_3(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
...
static void zT1_alpha2_adj_0_0(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
...
static void zT1_alpha2_adj_0_1(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
        md_clear(data->N, data->map_dims, dst, CFL_SIZE);
...
static void zT1_alpha2_adj_0_2(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
        md_clear(data->N, data->map_dims, dst, CFL_SIZE);
...
static void zT1_alpha2_adj_0_3(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
        md_clear(data->N, data->map_dims, dst, CFL_SIZE);
...
static void zT1_alpha2_adj_1_0(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
...
static void zT1_alpha2_adj_1_1(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
        md_clear(data->N, data->map_dims, dst, CFL_SIZE);
...
static void zT1_alpha2_adj_1_2(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
        md_clear(data->N, data->map_dims, dst, CFL_SIZE);
...
static void zT1_alpha2_adj_1_3(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1_alpha2_s, _data);
        md_clear(data->N, data->map_dims, dst, CFL_SIZE);
...
struct nlop_s* nlop_T1_alpha2_create(int N, const long map_dims[N], const long out_dims[N], const long TI_dims[N], const complex float* TI, bool use_gpu)
{
	...
	md_copy_strides(N, nl_istr[1], data->map_strs);
        ...
        return nlop_generic_create2(2, N, nl_odims, nl_ostr, 4, N, nl_idims, nl_istr, CAST_UP(PTR_PASS(data)), zT1_alpha2_fun, 
                                    (nlop_fun_t[4][2]){{ zT1_alpha2_der_0_0, zT1_alpha2_der_1_0 }, {zT1_alpha2_der_0_1, zT1_alpha2_der_1_1 }, { zT1_alpha2_der_0_2,  zT1_alpha2_der_1_2 }, { zT1_alpha2_der_0_3,  zT1_alpha2_der_1_3 }}, 
                                    (nlop_fun_t[4][2]){{ zT1_alpha2_adj_0_0, zT1_alpha2_adj_1_0 }, {zT1_alpha2_adj_0_1, zT1_alpha2_adj_1_1 }, { zT1_alpha2_adj_0_2 , zT1_alpha2_adj_1_2 }, { zT1_alpha2_adj_0_3 , zT1_alpha2_adj_1_3 }}, NULL, NULL, zT1_alpha2_del);
