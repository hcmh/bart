...
static void zT1relax_so_der_0_0(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1relax_so_s, _data);
...
static void zT1relax_so_der_0_1(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1relax_so_s, _data);
        md_zmul2(data->N, data->out_dims, data->out_strs, dst, data->map_strs, src, data->out_strs, data->dM0);
}

static void zT1relax_so_der_0_2(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1relax_so_s, _data);       
...
static void zT1relax_so_adj_0_0(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1relax_so_s, _data);
...
static void zT1relax_so_adj_0_1(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1relax_so_s, _data);
        md_clear(data->N, data->map_dims, dst, CFL_SIZE);
...
static void zT1relax_so_adj_0_2(const nlop_data_t* _data, complex float* dst, const complex float* src)
{
	const auto data = CAST_DOWN(zT1relax_so_s, _data);
        md_clear(data->N, data->map_dims, dst, CFL_SIZE);
...
struct nlop_s* nlop_T1relax_so_create(int N, const long map_dims[N], const long out_dims[N], const long TI_dims[N], const complex float* TI)
{
	...
	md_copy_strides(N, nl_istr[1], data->map_strs);
        ...
        return nlop_generic_create2(1, N, nl_odims, nl_ostr, 3, N, nl_idims, nl_istr, CAST_UP(PTR_PASS(data)), zT1relax_so_fun, 
                                    (nlop_fun_t[3][1]){{ zT1relax_so_der_0_0 }, {zT1relax_so_der_0_1 }, { zT1relax_so_der_0_2 }}, 
                                    (nlop_fun_t[3][1]){{ zT1relax_so_adj_0_0 }, {zT1relax_so_adj_0_1 }, { zT1relax_so_adj_0_2 }}, 
