...
MODULES_nlinv = -lnoir -liter -lnlops -llinops -lnoncart -lwavelet
...
# lib num
UTARGETS += test_multind test_flpmath test_splines test_linalg test_polynom test_window test_conv test_rand
