...
# lib simu
UTARGETS += test_ode_bloch test_tsegf test_biot_savart test_biot_savart_fft test_ode_simu test_ode_pulse test_signals test_epg test_fd_geometry test_sparse test_pde test_linop_leray
