...
TRECO=pics pocsense sqpics itsense nlinv moba nufft rof tgv sake wave lrmatrix estdims estshift estdelay wavepsf wshfl rtnlinv pixelfit
...
MODULES_pixelfit = -lmoba -lnlops -llinops -lsimu -liter
