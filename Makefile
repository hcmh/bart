...
TRECO=pics pocsense sqpics itsense nlinv T1fun moba mobaT2star mdbT2 modbloch pixel nufft rof tgv sake wave lrmatrix estdims estshift estdelay wavepsf wshfl hornschunck ncsense kmat power approx kernel dcnn rtreco rtnlinv
...
TNN=mnist nnvn nnmodl nnnullspace
...
UTARGETS += test_blas test_mdfft test_filter test_conv test_ops test_matexp test_ops_p test_specfun test_convcorr test_flpmath_strides
