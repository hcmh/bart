...
MODULES_bart = -lbox -lgrecon -lsense -lnoir -liter -llinops -lwavelet -llowrank -lnoncart -lcalib -lsimu -lsake -ldfwavelet -lnlops -lrkhs -lnn -lnlops -lmanifold -lmoba -lgeom -lnlops
MODULES_sake = -lsake
...
default all clean allclean distclean doc/commands.txt doxygen test utest utest_gpu gputest testague $(TARGETS):
