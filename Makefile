...
MODULES_moba = -lmoba -lnoir -liter -lnlops -lwavelet -lnoncart -lgrecon -llinops -llowrank -lsimu -lnn
...
# lib moba
UTARGETS += test_moba
MODULES_test_moba += -lmoba -lnoir -llowrank -lwavelet -liter -lnlops -llinops -lsimu -lnn
