...
tests/test-mdb-bloch: phantom creal saxpy conj threshold ones fmac cabs join copy bloch fft modbloch slice avg show repmat nrmse
	...
	$(TOOLDIR)/modbloch -t0.0045 -e0.00225 -R2 -i15 -f1 -S1 -s15 -m10 -a1 -w0.001 -r0 -I b1.ra -p psf.ra -P slice_profile.ra sig_ksp.ra reco.ra sens.ra	;\
	...
	$(TOOLDIR)/nrmse -t 0.005 ref.ra reco_masked.ra														;\
