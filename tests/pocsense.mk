...
tests/test-pocsense-wl: pocsense normalize noise nrmse $(TESTS_OUT)/shepplogan_coil_ksp.ra $(TESTS_OUT)/coils.ra
	set -e; mkdir $(TESTS_TMP) ; cd $(TESTS_TMP)                                    ;\
	$(TOOLDIR)/normalize 8 $(TESTS_OUT)/coils.ra coilsnorm.ra			;\
	$(TOOLDIR)/noise -n 10 $(TESTS_OUT)/shepplogan_coil_ksp.ra shepplogan_noise.ra ;\
...
TESTS += tests/test-pocsense-pi tests/test-pocsense-wl
